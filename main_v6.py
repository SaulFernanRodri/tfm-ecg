"""
Punto de entrada para el entrenamiento v6.2.

Diferencias respecto a main.py (v5):
    - Loss: AsymmetricLossPerClass con gamma_neg diferenciado por clase
      [CD=3, HYP=2, MI=4, NORM=3, STTC=3]
    - Estrategia de umbral: F0.5-score (precision-focused) con recall mínimo
      por clase en lugar de sensibilidad-constrained global
    - Directorio de salida: saved_model/v6.2  /  results/v6.2
...
Uso:
    cd /home/saul/IA/TFM
    python Desarrollo/tfm-ecg/main_v6.py
"""
